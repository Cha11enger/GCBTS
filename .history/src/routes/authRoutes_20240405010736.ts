...
router.get('/oauth/authorize', passport.authenticate('github', { scope: [ 'user:email' ] }));

// GitHub redirects back to your app. Finish the authentication process
router.get('/oauth/authorize/callback', passport.authenticate('github', { failureRedirect: '/login' }), (req, res) => {
