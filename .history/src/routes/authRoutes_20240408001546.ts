...
// write function that gets access token from db and send json response with these access_token: access_token, token_type: token_type,refresh_token: "example_refresh_token", expires_in: 360
