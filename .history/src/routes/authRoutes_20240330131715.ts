...
// Handle GitHub OAuth callback and create user in database if it doesn't exist yet and redirect to GPT_CALLBACK_URL with same state and code while initiating auth
